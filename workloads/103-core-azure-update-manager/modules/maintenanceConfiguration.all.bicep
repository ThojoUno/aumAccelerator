/*
  maintenanceConfigurations.all.bicep
...
module modMaintConfigs './maintenanceConfiguration.bicep' = [for (mi,i) in parMaintenanceConfigurations: {
  name: mi.name
...
module modConfigAssignment './authorization/policy-assignment/main.bicep' = [for (maintCfg, i) in parMaintenanceConfigurations: {
